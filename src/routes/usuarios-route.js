...
router.get('/list/:id', isAuth, (req, res) => usersController.listPersonagemUsuario(req, res));
router.delete('/delete/:id/personagem/:id_item', isAuth, (req, res) => usersController.deletePersonagemUsuario(req, res));
